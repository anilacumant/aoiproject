...
const LeaveApprovalHR = () => {
  ...
  useEffect(() => {
    const fetchLeaveRequests = async () => {
      try {
        const response = await axios.get("http://127.0.0.1:5000/api/leaves/hr");
  ...
  return (
    <div className="leave-approval-container">
      <header className="leave-approval-header">HR Leave Approval</header>
...
export default LeaveApprovalHR;
